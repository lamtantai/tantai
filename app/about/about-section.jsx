    ...
    <section className="text-secondary lg:text-balance">
      <Container>
        <div className="flex flex-col gap-y-10 md:flex-row md:gap-x-10">
          <h2 className="text-xl font-semibold md:flex-1 lg:text-3xl 2xl:text-6xl/tight">
            <SplitText
        ...
        <h2 className="py-space-md text-xl font-semibold lg:ml-[30%] lg:text-end lg:text-3xl 2xl:text-6xl/tight">
          <SplitText
